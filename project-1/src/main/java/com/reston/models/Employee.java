...
public class Employee {
	...
	public Employee(int id, String username, String password, String firstName, String lastName, String phoneNumber,
	...
	public static Employee usernameAndPassword(String username, String password) {
		
		final Employee empUserPass = new Employee();
		empUserPass.username = username;
		empUserPass.password = password;
		return empUserPass;
	}
